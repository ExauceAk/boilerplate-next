...
type RequestInterceptorType = (config: RequestInit) => RequestInit | Promise<RequestInit>;

type ResponseInterceptorType = (response: Response) => Response | Promise<Response>;
...
export class FetchService {
  ...
  public async fetch(url: string, options?: RequestInit) {
    ...
    const formattedUrl = this.baseUrl && url.startsWith("/") ? path.join(new URL(this.baseUrl).pathname, url) : url;

    const response = await fetch(new URL(formattedUrl, this.baseUrl), newOptions);
   ...
   * @param options - The options for the request.
   */
  public async post(url: string, body?: RequestInit["body"], options?: Omit<RequestInit, "method" | "body">) {
   ...
   * @param options - The options for the request.
   */
  public async put(url: string, body?: RequestInit["body"], options?: Omit<RequestInit, "method" | "body">) {
    return this.fetch(url, {
      ...options,
      method: "PUT",
      body,
   ...
   * @param options - The options for the request.
   */
  public async patch(url: string, body?: RequestInit["body"], options?: Omit<RequestInit, "method" | "body">) {
    return this.fetch(url, {
      ...options,
      method: "PATCH",
      body,
   ...
   * @param options - The options for the request.
   */
  public async deletMultiple(url: string, body?: RequestInit["body"], options?: Omit<RequestInit, "method" | "body">) {
    return this.fetch(url, {
      ...options,
      method: "DELETE",
      body,
